...
public class EncargaturaJerarquico {
    // constantes
    ...
    public static double calcularSalarioMensual(String categoria){
        ...
        switch (categoria) {
            case OCTAVA:
                salarioMensual = 1470.21 + 180;
                break;
            case SEPTIMA:
                salarioMensual = 1330.19 +180;
                break;
            case SEXTA:
                salarioMensual = 1225.18+ 180;
                break;
            case QUINTA:
                salarioMensual = 1050.15+ 180;
                break;
            case CUARTA:
                salarioMensual = 910.13+ 180;
                break;
            case TERCERA:
                salarioMensual = 840.12+ 180;
                break;
            case SEGUNDA:
                salarioMensual = 770.11+ 180;
                break;
            case PRIMERA:
                salarioMensual = 700.10+ 180;
                break;
