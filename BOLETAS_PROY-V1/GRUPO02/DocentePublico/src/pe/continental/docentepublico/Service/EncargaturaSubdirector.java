...
public class EncargaturaSubdirector {
    // constanteS
    ...
    public static double calcularSalarioMensual(String categoria){
        ...
        switch (categoria) {
            case OCTAVA:
                salarioMensual = 1470.21 + 240;
                break;
            case SEPTIMA:
                salarioMensual = 1330.19 +240;
                break;
            case SEXTA:
                salarioMensual = 1225.18+240;
                break;
            case QUINTA:
                salarioMensual = 1050.15+240;
                break;
            case CUARTA:
                salarioMensual = 910.13+240;
                break;
            case TERCERA:
                salarioMensual = 840.12+240;
                break;
            case SEGUNDA:
                salarioMensual = 770.11+240;
                break;
            case PRIMERA:
                salarioMensual = 700.10+240;
                break;
