...
public class EncargaturaDirector {
    ...
    public static double calcularSalarioMensual(String categoria) {
        ...
        switch (categoria) {
            case OCTAVA:
                salarioMensual = 1470.21 + 360;
                break;
            case SEPTIMA:
                salarioMensual = 1330.19 + 360;
                break;
            case SEXTA:
                salarioMensual = 1225.18 + 360;
                break;
            case QUINTA:
                salarioMensual = 1050.15 + 360;
                break;
            case CUARTA:
                salarioMensual = 910.13 + 360;
                break;
            case TERCERA:
                salarioMensual = 840.12 + 360;
                break;
            case SEGUNDA:
                salarioMensual = 770.11 + 360;
                break;
            case PRIMERA:
                salarioMensual = 700.10 + 360;
                break;
...
public static double calcularAsignacionFamiliar(int numeroHijos) {
    ...
    public static double calcularRemuneracionMensual(int numeroHijos, String categoria) {
        ...
        //proceso
        remuneracionMensual = calcularSalarioMensual(categoria)+ calcularAsignacionFamiliar(numeroHijos)-calcularEssalud(categoria)-calcularOnp(categoria);
        // reporte:
