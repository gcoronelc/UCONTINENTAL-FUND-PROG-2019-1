...
public class Prueba1 {
    ...
    public static void main(String[] args) {
        ...
        dto.setListaDeCursos(IETodoLoSabeSERVICE.WebConPHP);
        dto.setNivel(IETodoLoSabeSERVICE.Basico);
        // PROCESO
        ...
        System.out.println("Lista de Cursos:" + IETodoLoSabeSERVICE.WebConPHP);
        System.out.println("Nivel de Educacion:" + IETodoLoSabeSERVICE.Basico + "\n" + "\n");
